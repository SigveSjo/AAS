"""
Django settings for internal_interface project.
...
SECRET_KEY = '!@%lj3y9%vpy!d%_bine7i*dguy-t*+0ssmm%0n257em5yr1a5'
...
MIDDLEWARE = [
    ...
    'aas_api.request_handler.RequestMiddleware',
]

ROOT_URLCONF = 'internal_interface.urls'
