...
osascript -e 'tell application "Terminal" to do script "( cd git/AAS/internal_interface && export DJANGO_SETTINGS_MODULE=internal_interface.settings && daphne -b '$ip' -p '$port' internal_interface.asgi:application )"'
