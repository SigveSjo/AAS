...
function TurtleBotGeneralCommands(props) {
        ...
        <Paper className={classes.padding}>
            <div className={classes.margin}>
                <Grid container justify="center">
                    <div> TurtleBot General Commands </div>
                </Grid>
                <Grid container spacing={8} alignItems="flex-end">
                    ...
                    <Grid item md={true} sm={true} xs={true}>
                        <TextField onChange={handleOnChange} id="turtlebot" type="string" fullWidth autoFocus label="TurtleBot command" disabled={!enabled}/>
                    </Grid>
                </Grid>
...
export default withStyles(styles)(TurtleBotGeneralCommands)